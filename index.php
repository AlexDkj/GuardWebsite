...
include '96f22cf23a356e6cd44e-9280f9c18469682dee7d065dacc263e90a57f426/csrf.class.php';
header("Content-Security-Policy: script-src 'self' image-src 'self'");
...
$cookie_value = hash('sha1',generateRandomString());
$httponly = True;
$secure = True;
setcookie($cookie_name, $cookie_value,0, "/");
$cookie_name = "auth_csrf";
$cookie_value = hash('sha1',generateRandomString());
setcookie($cookie_name, $cookie_value,0, "/",$httponly);
		...
		if (!isset($uid)) {
			switch($auth_allow) {
				...
				case 2 : $warning .= "<br /><font color='red'>".$langInvalidId ."</font><br />"; 
					break;
				case 3 : $warning .= "<br />".$langAccountInactive1." <a href='modules/auth/contactadmin.php?userid=".$user."&&".$token_value."'>".$langAccountInactive2."</a><br /><br />"; 
					break;
